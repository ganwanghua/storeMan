...
/**
 * Created by ThinkPad-T430 on 2018/9/15.
 */
...
public class ActivityUtils {
     ...
     * @param bundle 数据
     */
    public static void startActivityForBundleDataForResult(Activity act, Class<?> cls, Bundle bundle, int resultCode) {
        Intent intent = new Intent(act, cls);
        intent.putExtras(bundle);
     ...
     * @param isShowBottom
     */
    public static void startBaseWebActivity(Context context, String title, String url, boolean isShowBottom) {
        Bundle bundle = new Bundle();
//        bundle.putString(BaseWebActivity.BUNDLE_KEY_TITLE, title);
//        bundle.putString(BaseWebActivity.BUNDLE_KEY_URL, url);
//        bundle.putBoolean(BaseWebActivity.BUNDLE_KEY_SHOW_BOTTOM_BAR, isShowBottom);
//        ActivityUtils.startActivityForBundleData(context, BaseWebActivity.class, bundle);
    }
...
//        et_tele.setText(contacts[1]);
    ...
    public static void sendSMS(Context context, String webUrl) {
        String smsBody = "推荐给你哦~ 地址:" + webUrl;
